            ...
            <div class="sticky">
                ...
                <div class="app-sidebar">
                    <div class="side-header">
                        <a class="header-brand1" href="{{url('categories')}}">
                            <img src="{{asset('assets/images/brand/logo-custom.jpg')}}" class="header-brand-img desktop-logo" alt="logo">
                            <img src="{{asset('assets/images/brand/logo-custom.jpg')}}" class="header-brand-img toggle-logo" alt="logo">
                            <img src="{{asset('assets/images/brand/logo-custom.jpg')}}" class="header-brand-img light-logo" alt="logo">
                            <img src="{{asset('assets/images/brand/logo-custom.jpg')}}" class="header-brand-img light-logo1" alt="logo">
                        </a><!-- LOGO -->
                    </div>
                    <div class="main-sidemenu">
                        ...
                        <ul class="side-menu">
							...
							<li class="slide">
								<a class="side-menu__item has-link" data-bs-toggle="slide" href="{{route('show.dashboard')}}">
